  ...
  S.list()
    ...
    .items([
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem().title('News & Events (Featured)').child(
                S.documentList().title('Featured News & Events').apiVersion('2024-01-01').filter('_type == "newsEvent" && isFeatured == true')
              ),
          ...
          S.list()
            ...
            .items([
              ...
              S.listItem().title('Chairmans').child(
                S.documentList().title('Chairmans').apiVersion('2024-01-01').filter('_type == "historicalPerson" && type == "chairman"')
              ),
              S.listItem().title('Secretary Managers').child(
                S.documentList().title('Secretary Managers').apiVersion('2024-01-01').filter('_type == "historicalPerson" && type == "secretary"')
              ),
            ])
        ),
        ...
        .child(
          S.list().title('Team').items([
            S.listItem().title('Board of Directors').child(
              S.documentList().title('Board of Directors').apiVersion('2024-01-01').filter('_type == "teamMember" && type == "board"')
            ),
            S.listItem().title('Staff').child(
              S.documentList().title('Staff').apiVersion('2024-01-01').filter('_type == "teamMember" && type == "staff"')
            ),
          ])
        ),
        ...
        .child(
          S.list().title('Trustees').items([
            ...
            S.listItem().title('Current Trustees (Board)').child(
              S.documentList().title('Current Trustees').apiVersion('2024-01-01').filter('_type == "teamMember" && type == "board"')
            ),
        ...
        .child(
          S.list().title('Projects').items([
            S.listItem().title('Active Projects').child(
              S.documentList().title('Active Projects').apiVersion('2024-01-01').filter('_type == "project" && status == "active"')
            ),
            S.listItem().title('Completed Projects').child(
              S.documentList().title('Completed Projects').apiVersion('2024-01-01').filter('_type == "project" && (status == "completed" || status == "complete")')
            ),
      ...
      S.listItem()
        .title('📰 News & Events')
        .child(
          S.list().title('News & Events').items([
            S.listItem().title('News Articles').child(
              S.documentList().title('News Articles').apiVersion('2024-01-01').filter('_type == "newsEvent" && type == "news"')
            ),
            S.listItem().title('Upcoming Events').child(
              S.documentList().title('Upcoming Events').apiVersion('2024-01-01').filter('_type == "newsEvent" && type == "upcoming"')
            ),
            S.listItem().title('Past Events').child(
              S.documentList().title('Past Events').apiVersion('2024-01-01').filter('_type == "newsEvent" && type == "event"')
            ),
            S.listItem().title('Announcements').child(
              S.documentList().title('Announcements').apiVersion('2024-01-01').filter('_type == "newsEvent" && type == "announcement"')
            ),

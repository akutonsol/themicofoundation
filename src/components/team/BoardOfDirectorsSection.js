  ...
  return (
    ...
    >
      ...
      <div className="mt-3">
        ...
        <h3 className="mt-1 text-[20px] font-semibold leading-[1.2] tracking-[-0.02em] text-[#040617]" style={{ fontFamily: "'Inter', sans-serif" }}>{member.name}</h3>
      </div>
    </motion.button>
  );
}
...
export default function BoardOfDirectorsSection() {
  ...
  return (
    <>
      <section>
        <div className="mb-10 grid gap-8 lg:grid-cols-[1fr_280px_460px] lg:items-stretch">
          <div className="flex items-center justify-center text-center">
            <h1 className="whitespace-nowrap text-[44px] font-semibold leading-[0.95] tracking-[-0.05em] text-[#040617] sm:text-[56px] lg:text-[70px]" style={{ fontFamily: "'Inter', sans-serif" }}>
              Board of Directors
            </h1>
          </div>

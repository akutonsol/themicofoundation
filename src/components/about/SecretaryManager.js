...
function BackgroundGrid() {
  return (
    <div className="pointer-events-none absolute inset-0 overflow-hidden">
      ...
      {/* Accent Stars */}
      <div className="absolute left-[3%] top-[6%] text-[40px] text-[#F7D534]">
        ✦
      </div>

      <div className="absolute right-[20%] top-[24%] text-[40px] text-[#F7D534]">
        ✦
      </div>

      <div className="absolute right-[18%] bottom-[22%] text-[40px] text-[#F7D534]">
        ✦
      </div>
    </div>
  );
        ...
        <div className="mt-16 grid gap-x-10 gap-y-14 sm:grid-cols-2 lg:grid-cols-3">
          {managers.map((person, index) => (
            ...
            >
              ...
              {/* Years */}
              <p
                className="mt-4 text-[18px] leading-[1.2] text-[#7A7D8B]"
                style={inter}
              >
                {person.years}
              </p>
              ...
              {/* Name */}
              <h3
                className="mt-1 text-[28px] font-semibold leading-[1.18] tracking-[-0.05em] text-[#040617] sm:text-[30px]"
                style={inter}
              >
                {person.name}
              </h3>

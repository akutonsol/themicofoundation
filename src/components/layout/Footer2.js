...
export default function Footer() {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#101728]">
      {/* TOP BADGES */}
      <div className="border-b border-black/5 bg-[#EEF2F2] py-10">
        <div className="mx-auto flex max-w-[1400px] flex-wrap items-center justify-center gap-10 px-6">
          {badges.map((badge, i) => (
            <img
              key={i}
              src={badge.img}
        ...
        <div className="relative mx-auto max-w-[1450px] px-6 py-20 lg:px-10">
          <div className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr_1fr]">
            ...
            <div>
              ...
              <p
                ...
                style={inter}
              >
                The Mico Foundation supports educational advancement,
                restoration initiatives, scholarships, and community-centered
                development projects across Jamaica and the wider Caribbean.
              </p>

              <a
                href="/donate"
                className="mt-10 inline-flex items-center gap-3 rounded-full bg-[#FFD900] px-7 py-4 text-[15px] font-bold uppercase tracking-[0.08em] text-[#040617] no-underline transition hover:scale-[1.02]"
                style={inter}
              >
                Donate Now
              </a>
              ...
              <div className="mt-10">
                <img
                  src="/images/footer/validated-organization.png"
                  alt="Validated Organization"
                  className="w-[180px]"
                />
              </div>
            </div>
              ...
              <div className="space-y-10">
                ...
                <div className="flex gap-5 border-b border-white/10 pb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[18px] font-medium text-white" style={inter}>
                      +1-876-984-5005
                    </p>
          ...
          <div className="mt-20 flex flex-col gap-10 border-t border-white/10 pt-10 lg:flex-row lg:items-center lg:justify-between">
              ...
              <div className="flex items-center gap-4">
                {socials.map((social, i) => (
                  <a
                    ...
                    className="flex h-11 w-11 items-center justify-center rounded-full bg-white text-black transition hover:scale-[1.08]"
                  >
                    <img
                      src={social.img}
                      alt=""
            ...
            <div className="text-left lg:text-right">
              ...
              <p
                className="mt-3 text-[15px] text-white/45"
                style={inter}
              >

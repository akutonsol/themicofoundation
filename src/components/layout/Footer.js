    ...
    <footer className="relative overflow-hidden bg-[#1A1600]">
      ...
      <div className="relative overflow-hidden">
        <div className="absolute inset-0 opacity-[0.08]">
          <img src="/images/home-static/mico-frontgate.jpg" alt="" className="h-full w-full object-cover" />
        </div>
        ...
        <div className="relative mx-auto max-w-[1450px] px-6 py-20 lg:px-10">
          <div className="grid gap-16 lg:grid-cols-[1.1fr_0.9fr_1fr]">
            ...
            {/* CONTACT */}
            <div>
              <h3 className="mb-8 text-[44px] font-semibold leading-[0.95] tracking-[-0.05em] text-white" style={inter}>Contact</h3>
              <div className="space-y-10">
                <div className="flex gap-5 border-b border-white/10 pb-8">
                  ...
                  <div>
                    ...
                    <p className="text-[18px] font-medium text-white" style={inter}>+1-876-984-5005</p>
                    <p className="text-[18px] font-medium text-white" style={inter}>+1-876-618-0141</p>
                    <p className="text-[18px] font-medium text-white" style={inter}>+1-876-907-3656</p>
                  </div>
                </div>
                <div className="flex gap-5 border-b border-white/10 pb-8">
                  <div className="flex h-14 w-14 items-center justify-center rounded-full border border-[#FFD900]/25 bg-[#FFD900]/10">
                  ...
                  <div>
                    ...
                    <p className="text-[18px] font-medium text-white" style={inter}>info@micofoundation.org</p>
                    <p className="text-[18px] font-medium text-white" style={inter}>support@micofoundation.org</p>
                  </div>
                </div>
                <div className="flex gap-5">
                  ...
                  <div>
                    ...
                    <p className="text-[18px] font-medium text-white" style={inter}>1A Marescaux Road</p>
                    <p className="text-[18px] font-medium text-white" style={inter}>Kingston, Jamaica</p>
                    <div className="mt-5">
                      <p className="mb-2 text-[14px] uppercase tracking-[0.12em] text-white/45" style={inter}>Opening Hours</p>
                      <p className="text-[17px] text-white" style={inter}>Monday - Friday: 8:00 am - 4:00 pm</p>
                      <p className="text-[17px] text-white" style={inter}>Saturday, Sunday: Closed</p>
                    </div>
                  </div>
                </div>
              </div>

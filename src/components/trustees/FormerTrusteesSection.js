...
const formerTrustees = [
  ...
  },
  {
    id: 3,
    years: "1984-2006",
    name: "Professor The Honourable Errol Miller, OJ CD",
    description:
    ...
    >
      ...
      <div className="relative overflow-hidden rounded-[22px] border border-black/10 bg-white">
        <img
          src={trustee.image}
          alt={trustee.name}
          className="h-[330px] w-[270px] object-cover sm:h-[380px] sm:w-[300px] lg:h-[420px] lg:w-[320px]"
        />
      </div>

      <p
        className="mt-4 text-[18px] text-black/55"
      ...
      <h3
        className="mt-1 max-w-[420px] text-[22px] font-semibold leading-[1.08] tracking-[-0.04em] text-black sm:text-[26px]"
        style={{ fontFamily: "'inter', sans-serif" }}
      >
        {trustee.name}
      </h3>
      ...
      <p
        className="mt-4 max-w-[430px] text-[18px] leading-[1.58] text-black/70 sm:text-[20px]"
        style={{ fontFamily: "'inter', sans-serif" }}
      >
        {trustee.description}
      </p>
    ...
    <section className="relative overflow-hidden bg-white px-5 pb-20 pt-10 sm:px-8 lg:px-12 lg:pb-28 lg:pt-14">
      ...
      <div className="relative mx-auto max-w-[1560px]">
        <div className="mx-auto max-w-[1400px] text-center">
          <p
            className="mx-auto max-w-[1420px] text-[24px] font-semibold leading-[1.35] tracking-[-0.03em] text-black/45 sm:text-[34px] lg:text-[40px]"
            style={{ fontFamily: "'inter', sans-serif" }}
          >
          ...
          <p
            className="mt-5 text-[24px] font-semibold text-black sm:text-[34px]"
            style={{ fontFamily: "'inter', sans-serif" }}
          >
          ...
          <h1
            className="mt-10 text-[56px] font-semibold leading-[0.95] tracking-[-0.06em] text-black sm:text-[82px] lg:text-[98px]"
            style={{ fontFamily: "'inter', sans-serif" }}
          >
            Former Trustees
          </h1>

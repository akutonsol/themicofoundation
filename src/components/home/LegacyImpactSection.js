          ...
          >
            ...
            <div className="mt-10 border-l border-[#E5E6EB] pl-6 sm:pl-8">
              <p
                ...
                style={inter}
              >
                The Mico Foundation exists to preserve the educational heritage
                of The Mico University College while advancing opportunities for
                future generations.
              </p>
              ...
              <p
                ...
                style={inter}
              >
                Through restoration projects, scholarships, institutional
                development, and community partnerships, every contribution helps
                strengthen a legacy that has transformed lives for nearly two
                centuries.
              </p>
            </div>
            ...
            <div className="relative overflow-hidden rounded-[34px] border border-[#E5E6EB] bg-[#040617] shadow-sm">
              ...
              <div className="absolute bottom-8 left-8 right-8">
                <p
                  ...
                  style={inter}
                >
                  Every generation deserves access to educational opportunity.
                </p>
              </div>
            </div>
